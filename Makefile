...
$(BIN)/sicasm: $(BLD)/sicasm.o $(BLD)/hash_table.o $(BLD)/pass_1.o $(BLD)/gen_ops.o $(BLD)/stack.o
	mkdir -p $(BIN)
	$(CC) $(BLD)/sicasm.o $(BLD)/hash_table.o $(BLD)/gen_ops.o $(BLD)/pass_1.o $(BLD)/stack.o -o $(BIN)/sicasm
